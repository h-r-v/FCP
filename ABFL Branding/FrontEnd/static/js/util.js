...
function main()
		{
			...
			else
			{
				...
				var primaryColor = '#ffd900';//'#cf0000';
				...
				prev.innerHTML = "Press preview to see the preview of your code here.";
				...
				undoButton.innerHTML = "<img src='images/undo.png' width=32 hight=32>";
				...
				redoButton.innerHTML = "<img src='images/redo.png' width=32 hight=32>";
				...
				zinButton.innerHTML = "<img src='images/zoom_in.png' width=32 hight=32>";
				...
				zoutButton.innerHTML = "<img src='images/zoom_out.png' width=32 hight=32>";
				...
				previewButton.innerHTML = "Preview Code";
				...
				document.getElementById('buttonBox').appendChild(downloadButton);
				downloadButton.onclick = function()
				{
					...
					$.ajax({
						type: 'POST',
						 ...
						 data: {"myKey": json},
						 success: function (data) {
							downloadfile('generated_py.txt', data);
						 }
					   });
				}
				document.getElementById('buttonBox').appendChild(downloadButton);
				...
				saveButton.innerHTML = "Save FlowChart";
				saveButton.onclick = function()
				{
					...
					var result = xmlToJSON.parseString(testString);
					var json = JSON.stringify(result);
					downloadfile('model.txt', json);
				}
				document.getElementById('buttonBox').appendChild(saveButton);
